...
LEFT JOIN Team Team1 
    ON GameTeams.CompetitionID = Team1.CompetitionID
    AND GameTeams.Team1ID = Team1.TeamID
LEFT JOIN Team Team2
    ON GameTeams.CompetitionID = Team2.CompetitionID
    AND GameTeams.Team2ID = Team2.TeamID
LEFT JOIN Team Team3
    ON GameTeams.CompetitionID = Team3.CompetitionID
    AND GameTeams.Team3ID = Team3.TeamID
